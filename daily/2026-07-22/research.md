...
> Daily digest compiled from multiple AI-news roundups and trackers. Fast-moving
> stories; figures reflect what sources reported as of 22 Jul 2026 and should be
> spot-checked before any high-stakes use.

## Top stories (ranked)

1. **Google ships three new Gemini models — but misses Pro again (Jul 21).**
   Released **Gemini 3.6 Flash**, **Gemini 3.5 Flash-Lite**, and **Gemini 3.5 Flash
...
- **Science / reasoning:** **Gemini 3.1 Pro** — GPQA Diamond **94.3%**, ARC-AGI-2 77.1%
- **Computer use:** **GPT-5.4** leads
- **Open-weight surge:** Kimi K3, GLM-5.2, DeepSeek V4, Qwen3.6

## Also notable
- **GPT-5.6** shipped as a lineup: **Sol** (flagship, Ultra subagent mode, Max
  reasoning), **Terra** (GPT-5.5 quality at ~half cost), **Luna** (fast tier).
- **Apple sued OpenAI**, alleging theft of hardware trade secrets.
- Enterprise agents: **Claude Cowork** (Jul 7), **ChatGPT Work**, Slack + Salesforce.
- Funding at record pace: Crunchbase pegs H1 2026 global startup investment at
  **~$510B**; Microsoft committing **$10B** to Japan AI data centres (2026–29).

## Sources
- llm-stats.com/ai-news · llm-stats.com/llm-updates
- thursdai.news/releases/2026-07
- buildfastwithai.com (AI News Today, Jul 20/21/22)
- techstartups.com (Top Tech News, Jul 21 2026)
- marketingprofs.com (AI Update, Jul 17 2026)
- crescendo.ai/news · news.crunchbase.com · siliconangle.com (PitchBook H1 2026)
- databricks.com newsroom (Coatue round)
- benchlm.ai · aireleasetracker.com
